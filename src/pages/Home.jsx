    ...
    return (
        <div className='home'>
            ...
            <section className="section-four">
                    <h1 className='newsletter'>Join our newsletter and get 20% off</h1>
                    <div className='newsletter-contact'>
                        ...
                        <div className='email-contact'>
                            <div className='form'>
                                <input type="text" placeholder="Enter Email" className='email-container'/>
